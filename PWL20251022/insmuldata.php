...
$fakeData = [
    [1, "Pensil Warna", 12000.50, 50, "Pensil warna untuk menggambar", "pensil.jpg"],
...
foreach ($fakeData as $data) {
    ...
    $sql = "INSERT INTO barang (nama, hrg, jml, keterangan, foto)
            VALUES ($id, \"$nama\", $hrg, $jml, \"$keterangan\", \"$foto\")";

    if ($conn->query($sql) === TRUE) {
        echo "Data multiple berhasil diinsert<br>";
    } else {
